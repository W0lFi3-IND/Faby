...
public class CalhistoryforDinner extends AppCompatActivity {
    ListView listview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calhistoryfor_dinner);
    ...
    protected void onStart() {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Calorie_Recorder").child("Dinner").child(uid);
        if (databaseReference != null) {
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    Calorielisting adapter = new Calorielisting(CalhistoryforDinner.this, list);
